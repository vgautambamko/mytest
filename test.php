...
echo 'First Development';
echo "new line added by Vijay kumar gautam";
echo "Arun Manchanda";
/*
...
<head>
  ...
  <meta property="og:url"           content="https://bamko.net" />
...
$url=urlencode('https://www.bamko.net/about_us.php');
$image=urlencode('https://img00.deviantart.net/8465/i/2009/260/f/a/blender__texture_dummy_by_3d_asuarus.jpg');
?>
